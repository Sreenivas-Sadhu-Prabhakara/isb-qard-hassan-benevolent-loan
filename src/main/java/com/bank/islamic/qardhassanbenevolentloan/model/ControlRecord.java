package com.bank.islamic.qardhassanbenevolentloan.model;
...
/**
 * The BIAN control record for this service domain: "Qard Hassan Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Qard Hassan Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Qard Hassan Facility Fulfillment Arrangement";
